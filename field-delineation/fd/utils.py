...
from pathlib import Path #Ajout joseph pour retirer AWS


@dataclass
class BaseConfig:
    # Modif joseph pour retirer AWS
    local_storage_path: str
    sh_client_id: Optional[str] = None
    sh_client_secret: Optional[str] = None


def prepare_filesystem(config: BaseConfig) -> Path:
    # Modif joseph pour retirer AWS
    # Utilisation d'un chemin local
